...
# -*- coding: utf-8 -*-
"""
Created on Thu Feb 16 11:30:42 2023
...
assets = [{'name': 'Square1',
  'colour': 'Blue',
  'is_mat': True,
  'home_pos': {'x': -0.16599999368190765,
   'y': 1.014931559562683,
   'z': 4.519999980926514}},
 {'name': 'Square2',
  'colour': 'Blue',
 ...
 {'name': 'Circle1',
  'colour': 'Blue',
  'is_mat': True,
  'home_pos': {'x': 0.13899999856948853,
   'y': 1.014931559562683,
   'z': 4.519999980926514}},
 {'name': 'Circle2',
  'colour': 'Blue',
 ...
 {'name': 'Apple1',
  'colour': 'Red',
  'is_mat': False,
  'home_pos': {'x': 0.4650000035762787,
   'y': 1.010363221168518,
   'z': 4.519000053405762}},
 {'name': 'Apple1Slice',
  'colour': 'Red',
  'is_mat': False,
  'home_pos': {'x': 0.4970000386238098,
   'y': 1.0333632230758667,
   'z': 4.843000411987305}},
 {'name': 'Apple2',
  'colour': 'Green',
  'is_mat': False,
  'home_pos': {'x': 0.4659999907016754,
   'y': 1.0103631019592285,
   'z': 5.067399978637695}},
 {'name': 'Apple2Slice',
  'colour': 'Green',
  'is_mat': False,
  'home_pos': {'x': 0.4860000014305115,
   'y': 1.0333631038665771,
   'z': 5.378699779510498}},
 {'name': 'Apple3',
  'colour': 'Yellow',
  'is_mat': False,
  'home_pos': {'x': 0.5040000081062317,
 ...
 {'name': 'Cup1',
  'colour': 'Green',
  'is_mat': False,
  'home_pos': {'x': 0.7879971265792847,
   'y': 1.0067720413208008,
   'z': 4.549003601074219}},
 {'name': 'Cup2',
  'colour': 'Orange',
  'is_mat': False,
  'home_pos': {'x': 0.8199986219406128,
   'y': 1.0067719221115112,
   'z': 4.806990623474121}},
 {'name': 'Bowl1',
  'colour': 'Black',
  'is_mat': False,
  'home_pos': {'x': 1.07542085647583,
   'y': 0.910454273223877,
   'z': 4.49299955368042}},
 {'name': 'Bowl2',
  'colour': 'Brown',
  'is_mat': False,
  'home_pos': {'x': 1.0049999952316284,
   'y': 0.8298299908638,
   'z': 4.761000156402588}},
 {'name': 'Bowl3',
  'colour': 'Grey',
  'is_mat': False,
  'home_pos': {'x': 0.9849997162818909,
   'y': 0.7876260280609131,
   'z': 5.063000202178955}},
 {'name': 'Bread1',
  'colour': 'White',
  'is_mat': False,
  'home_pos': {'x': 1.3809998035430908,
   'y': 0.9848300814628601,
   'z': 4.497000217437744}},
 {'name': 'Bread1Slice',
  'colour': 'White',
  'is_mat': False,
  'home_pos': {'x': 1.3694748878479004,
   'y': 1.14316987991333,
   'z': 4.797289848327637}},
 {'name': 'Bread2',
  'colour': 'Brown',
  'is_mat': False,
  'home_pos': {'x': 1.38100004196167,
   'y': 0.9848302006721497,
   'z': 5.063000202178955}},
 {'name': 'Bread2Slice',
  'colour': 'Brown',
  'is_mat': False,
  'home_pos': {'x': 1.3558368682861328,
   'y': 1.1330000162124634,
   'z': 5.32420015335083}},
 {'name': 'Egg1',
  'colour': 'Brown',
  'is_mat': False,
  'home_pos': {'x': 1.6330000162124634,
 ...
 {'name': 'Pan1',
  'colour': 'Silver',
  'is_mat': False,
  'home_pos': {'x': 1.833000659942627,
   'y': 0.9288299083709717,
   'z': 4.549003601074219}},
 {'name': 'Pan2',
  'colour': 'Black',
  'is_mat': False,
  'home_pos': {'x': 1.8330004215240479,
   'y': 0.9288310408592224,
   'z': 4.799300193786621}},
 {'name': 'Plate1',
  'colour': 'White',
  'is_mat': False,
  'home_pos': {'x': 2.1510000228881836,
 ...
 {'name': 'Vase1',
  'colour': 'Red',
  'is_mat': False,
  'home_pos': {'x': 2.3968935012817383,
   'y': 1.0388307571411133,
   'z': 4.544688701629639}},
 {'name': 'Vase2',
  'colour': 'Yellow',
  'is_mat': False,
  'home_pos': {'x': 2.400003433227539,
   'y': 1.038827896118164,
   'z': 4.734003067016602}}];
...
class Items:
    ...
    def get_asset(self,name):
        ...
        if len(named_assets) > 1:
            raise DuplicateAssetError("More than one asset in the asset list has the name {}.".format(name));
