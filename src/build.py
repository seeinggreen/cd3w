...
class Build:
    def __init__(self) -> None:
        ...
        self.local_build_path = None

    def get_local_build_path(self):
        """
        ...
        if system == "Darwin":
            if not os.path.exists("builds/thor-OSXIntel64-local/thor-OSXIntel64-local"):
                ...
                self.local_build_path = "thor-OSXIntel64-local"
        elif system == "Linux":
            if not os.path.exists("builds/thor-Linux64-local/thor-Linux64-local"):
                ...
                self.local_build_path = "builds/thor-Linux64-local/thor-Linux64-local"
        elif system == "Windows":
