...
def save_test_configs():
    ...
    leader_objects[1][1] = "Apple2"
    leader_objects[1][2] = "Apple1"
    leader_objects[3][0] = "Bread2Slice"

    follower_objects = Table.get_empty_slots_list()
    follower_objects[0][1] = "Vase1"
    follower_objects[2][0] = "Plate1"
    follower_objects[2][1] = "Cup1"
    follower_objects[3][1] = "Cup2"
    follower_objects[4][0] = "Apple2"
    follower_objects[4][1] = "Bread2Slice"
